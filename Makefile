...
PROFILE = name of the gcp project
PROJECT_NAME = odonto-fraude
...
EXPERIMENT_RUN = $(shell date '+%Y%m%d%H%M%S') 
VERSION_FILE = $(COMMIT_HASH)$(EXPERIMENT_RUN)
...
page_type:
	$(PYTHON_INTERPRETER) odonto/models/page_type/train.py

evaluate_page_type:
	$(PYTHON_INTERPRETER) odonto/models/page_type/evaluate.py
